...
namespace AppCep.Service
{
    public class DataService
    {
        public static async Task<Endereco> GetEnderecoByCep(string cep)
        {
            ...
            {
                HttpResponseMessage response = await client.GetAsync("https://10.0.0.2.2:8000/endereco/by-cep?cep=" + cep);
        ...
        public static async Task<List<Bairro>> GetBairrosByIdCidade(string id_cidade)
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                HttpResponseMessage response = await client.GetAsync("https://10.0.0.2.2:8000/bairro/by-cidade?id_cidade=" + id_cidade);
        ...
        public static async Task<List<Cidade>> GetCidadesByEstado(string uf)
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                HttpResponseMessage response = await client.GetAsync("https://10.0.0.2.2:8000/cidade/by-uf?uf=" + uf);
        ...
        public static async Task<List<Logradouro>> GetLogradouroByBairroAndCidade(string bairro, string id_cidade)
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                HttpResponseMessage response = await client.GetAsync("https://10.0.0.2.2:8000/logradouro/by-bairro?id_cidade=" + id_cidade + "&bairro=" + bairro );
        ...
        public static async Task<List<Cep>> GetCepsByLogradouro(string logradouro)
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                HttpResponseMessage response = await client.GetAsync("https://10.0.0.2.2:8000/cep/by-logradouro?logradouro=" + logradouro);
